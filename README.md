# ZkSync Era Token Creation Tool

A simple frontend tool to create tokens on the ZkSync Era network using a backend API.
...
- Insert this project link https://github.com/BayHatter/ZkSync-Era-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your ZkSync Era Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/ZkSync-Era-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your ZkSync Era wallet address for receiving fees. Also set fee in ETH that you want to charge
